...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <h4 class="Task-Management-Platform Task-Management-Platform-big-screen">URL Shortener App</h4>
        <ul class="navbar-nav navbar-nav-right">
            ...
            <a class="nav-item nav-profile"  data-toggle="tooltip" data-placement="left" title="{{\Illuminate\Support\Facades\Auth::user()['name']}}">
